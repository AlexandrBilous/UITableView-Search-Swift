...
class Student: NSObject {
    ...
    static let names = ["Adam", "Alex", "Aaron", "Ben", "Carl", "Dan", "David", "Edward", "Fred", "Frank", "George", "Hal", "Hank", "Ike", "John", "Jack", "Joe", "Larry", "Monte", "Matthew", "Mark", "Nathan", "Otto", "Paul", "Peter", "Roger", "Roger", "Steve", "Thomas", "Tim", "Ty", "Victor", "Walter"]
    ...
    var components : DateComponents = {
        ...
        tmp.calendar = Calendar.current
        return tmp
    }()

    
    func randomSettings () {
        firstName = Student.names.randomElement() ?? ""
        lastName = Student.lastNames.randomElement() ?? ""
        
        components.day = Int.random(in: 0...365)
        components.year = Int.random(in: 1970...2020)
